...
builder.Services.AddMediatR(cfg => cfg.RegisterServicesFromAssembly(typeof(AddDebtCommand).Assembly));
...
builder.Services.AddOpenApi(options =>
{
    options.AddDocumentTransformer((document, context, cancellationToken) =>
    {
        document.Info = new Microsoft.OpenApi.Models.OpenApiInfo
        {
            ...
            Version = "v1",
            Description = "API RESTful de Gestión de Sueldos y Deudas Personales (Clean Architecture + CQRS).",
            Contact = new Microsoft.OpenApi.Models.OpenApiContact { Name = "Desarrollo", Email = "dev@example.com" },
