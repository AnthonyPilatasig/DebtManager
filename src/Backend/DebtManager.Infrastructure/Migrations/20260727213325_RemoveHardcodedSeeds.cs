...
namespace DebtManager.Infrastructure.Migrations
{
    ...
    public partial class RemoveHardcodedSeeds : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Debts",
                columns: new[] { "Id", "AnnualInterestRate", "CutoffDay", "DueDay", "IsCreditCard", "IsDeleted", "LastModifiedAt", "MinimumMonthlyPayment", "Name", "StartDate", "TotalBalance", "TotalQuotas", "UserId" },
                values: new object[,]
                {
                    { new Guid("20000000-0000-0000-0000-000000000001"), 18.5m, 30, 15, true, false, new DateTimeOffset(new DateTime(2026, 7, 23, 12, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), 60.00m, "Tarjeta de Crédito Visa", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 1200.00m, 24, new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("20000000-0000-0000-0000-000000000002"), 12.0m, null, 5, false, false, new DateTimeOffset(new DateTime(2026, 7, 23, 12, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), 250.00m, "Préstamo Vehicular", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 8500.00m, 60, new Guid("00000000-0000-0000-0000-000000000001") }
                });
            ...
            migrationBuilder.InsertData(
                table: "Payments",
                columns: new[] { "Id", "Amount", "DebtId", "IsDeleted", "IsExtraordinary", "LastModifiedAt", "PaymentDate" },
                values: new object[] { new Guid("30000000-0000-0000-0000-000000000001"), 250.00m, new Guid("20000000-0000-0000-0000-000000000002"), false, false, new DateTimeOffset(new DateTime(2026, 7, 23, 12, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), new DateTime(2026, 2, 5, 0, 0, 0, 0, DateTimeKind.Utc) });
        }
    }
}
